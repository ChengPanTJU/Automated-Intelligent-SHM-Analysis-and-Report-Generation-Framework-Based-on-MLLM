        ...
        if task=='assessment2':
            ...
            if len(reg_files) > 0:
                for i in range(len(reg_files)):
                    ...
                    save_path = os.path.join('PostProcessing', 'LLM_result', task, f"{save_name}_sum.txt")
            ...
            if len(traf_files) > 0:
                ...
                save_path = os.path.join('PostProcessing', 'LLM_result', task, "traf_sum.txt")
                os.makedirs(os.path.dirname(save_path), exist_ok=True)
                with open(save_path, "w", encoding="utf-8") as file:
                    file.write(output_text[0])
        else:
            ...
            if len(mean_rms_files)>0:
                ...
                save_path = os.path.join('PostProcessing', 'LLM_result', task, "type_sum.txt")
                os.makedirs(os.path.dirname(save_path), exist_ok=True)
                with open(save_path, "w", encoding="utf-8") as file:
                    file.write(output_text[0])
